"""initiated table pls work 2

Revision ID: 04ddc87abebd
Revises: 54579b52d8ef
Create Date: 2026-01-06 10:13:50.480158
...
revision: str = '04ddc87abebd'
down_revision: Union[str, Sequence[str], None] = '54579b52d8ef'
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('admin', 'pramusaji', name='userrole'), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_pesanan', sa.Integer(), nullable=True),
    sa.Column('metode', sa.Enum('cash', 'qris', name='metodepembayaran'), nullable=False),
    sa.Column('total', sa.Float(), nullable=False),
    sa.Column('waktu_bayar', sa.DateTime(), nullable=True),
    sa.Column('status', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['id_pesanan'], ['pesanan.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id_pesanan')
    )
